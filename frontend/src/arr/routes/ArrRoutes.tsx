...
import { ArrDiscoveryPage } from "@/arr/pages/ArrDiscoveryPage";
import { ArrDiscoveryLastfmPage } from "@/arr/pages/ArrDiscoveryLastfmPage";
...
export function ArrRoutes() {
  return (
    <Routes>
      ...
      <Route path="/similarr" element={<Navigate to="/discovery/lastfm" replace />} />
