...
async def test_connectivity():
    ...
    try:
        ...
        return ConnectivityTestResponse(results=results, overall_success=overall_success)
...
async def _test_lidarr() -> ConnectivityTestResult:
    ...
    try:
        ...
        if success:
            return ConnectivityTestResult(
                service="Lidarr", success=True, message="Connected successfully", status="success"
            )
        else:
            return ConnectivityTestResult(
                service="Lidarr",
...
async def _test_lastfm() -> ConnectivityTestResult:
    ...
    try:
        ...
        if success:
            return ConnectivityTestResult(
                service="Last.fm", success=True, message="Connected successfully", status="success"
            )
        else:
            return ConnectivityTestResult(
                service="Last.fm",
...
async def _test_plex() -> ConnectivityTestResult:
    ...
    try:
        ...
        if success:
            return ConnectivityTestResult(
                service="Plex", success=True, message="Connected successfully", status="success"
            )
        else:
            return ConnectivityTestResult(
                service="Plex",
...
async def _test_jellyfin() -> ConnectivityTestResult:
    ...
    try:
        ...
        if success:
            return ConnectivityTestResult(
                service="Jellyfin", success=True, message="Connected successfully", status="success"
            )
        else:
            return ConnectivityTestResult(
                service="Jellyfin",
