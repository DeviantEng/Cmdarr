...
class ConfigAdapter:
    ...
    def _setup_attributes(self):
        ...
        self.GENERATE_DEBUG_VALIDATION_CALLS = config_service.get(
            "GENERATE_DEBUG_VALIDATION_CALLS", True
        )
        ...
        self.DISCOVERY_LISTENBRAINZ_ENABLED = config_service.get(
            "DISCOVERY_LISTENBRAINZ_ENABLED", False
        )
        self.DISCOVERY_LISTENBRAINZ_SCHEDULE = config_service.get(
            "DISCOVERY_LISTENBRAINZ_SCHEDULE", 24
        )
        self.DISCOVERY_LISTENBRAINZ_LIMIT = config_service.get("DISCOVERY_LISTENBRAINZ_LIMIT", 5)
        self.LISTENBRAINZ_PLEX_PLAYLIST_ENABLED = config_service.get(
            "LISTENBRAINZ_PLEX_PLAYLIST_ENABLED", False
        )
        self.LISTENBRAINZ_PLEX_PLAYLIST_SCHEDULE = config_service.get(
            "LISTENBRAINZ_PLEX_PLAYLIST_SCHEDULE", 12
        )
        ...
        self.LIBRARY_CACHE_MEMORY_LIMIT_MB = config_service.get(
