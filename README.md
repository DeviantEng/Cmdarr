...
- **Artist events** – Ticketmaster Discovery feed for upcoming shows (`/events`), with search, distance filter, and per-artist or per-event hides. See [Artist events](readme-extended.md#event-sources-artist-events) in the extended docs.
