...
### Housekeeping
- **Docker image**: Removed apt `curl` from the runtime image; HEALTHCHECK uses a Python stdlib probe (`docker/healthcheck.py`) to drop OS-level libcurl CVE surface.
