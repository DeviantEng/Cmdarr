...
### Features
- **Similarr**: Interactive Last.fm similar-artist discovery page (searchable Lidarr library or Plex top-listened seeds, one-shot Run/Stop search, artwork cards, bios, per-page Lidarr quality/metadata profile pickers for Add, one-click Lidarr add with album search). Inspired by [Lidify](https://github.com/TheWicklowWolf/Lidify) by TheWicklowWolf.
